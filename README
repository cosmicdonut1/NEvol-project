...
- **Neural Network**: A neural network is trained and utilized for predicting motor imagery movements (e.g., hand movements) from the EEG signals.
- **Control System**: The neural network's predictions are used to control a simulation of a wheelchair in Blender in real-time.

## Requirements

- Python 3.x
- OpenBCI and Unicorn BCIs libraries
...
Contributions are welcomed. If you have any ideas or enhancements, please submit a pull request or open an issue.
